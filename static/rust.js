...
* @param {any} to_log
*/
export function js_log(to_log) {
    wasm.js_log(addHeapObject(to_log));
}
...
* @returns {any}
*/
export function unique_by(v) {
    const ret = wasm.unique_by(addHeapObject(v));
    return takeObject(ret);
}
...
* @returns {any}
*/
export function get_instance_of_person() {
    const ret = wasm.get_instance_of_person();
    return takeObject(ret);
}
...
* @returns {any}
*/
export function create_person(js_person) {
    const ret = wasm.create_person(addHeapObject(js_person));
    return takeObject(ret);
}
...
function getImports() {
    ...
    imports.wbg.__wbg_log_3b36ce27c924545c = function(arg0) {
    ...
    imports.wbg.__wbg_log_6e114ce888388e3b = function(arg0, arg1) {
